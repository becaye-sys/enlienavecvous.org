import {$document_body, portfolio_filter, $wrapper, $window, $sections, $portfolio_gallery, $portfolio_flex_slider, $portfolio_filter_first_child, $header, $footer, $body, $html, $document } from "./custom_vars";
